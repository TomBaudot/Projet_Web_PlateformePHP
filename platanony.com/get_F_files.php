<?php
  ...
  if(isset($_SESSION['admin_name']) && isset($_SESSION['admin_password'])){
    ...
    if(isset($_GET['filename']) && file_exists(ROOT_PATH . '/uploads/F_files_directory/' . $_GET['filename'] . '.json')){

      $filename = ROOT_PATH . '/uploads/F_files_directory/' . $_GET['filename'] . '.json';
